    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-gray-100 p-4 rounded-lg">
            ...
            <div class="flex gap-2 mt-2">
                <button class="text-blue-800 px-3 py-1 rounded">افزودن به سبد</button>
                <button class="text-red-800 px-3 py-1 rounded">حذف</button>
            </div>
            <div class="flex gap-2 mt-2">
                <button class="text-blue-800 px-3 py-1 rounded">مشاهده جزئیات</button>
                <button class="text-blue-800 px-3 py-1 rounded">افزودن به علاقه‌مندی‌ها</button>
            </div>
        </div>
